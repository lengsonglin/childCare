...
import com.cqut.childcare.minIo.domain.OssReq;
import com.cqut.childcare.minIo.domain.OssResp;
import io.minio.*;
...
public class MinIOTemplate {
    ...
    public OssResp getPreSignedObjectUrl(OssReq req) {
        ...
        return OssResp.builder()
                .uploadUrl(url)
                .downloadUrl(getDownloadUrl(ossProperties.getBucket(), absolutePath))
                .build();
    }
